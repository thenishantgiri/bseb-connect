...
import '../utilities/SharedPreferencesHelper.dart';
  ...
  class FullScreenWebView extends StatefulWidget {
    ...
    final String dob;
    FullScreenWebView({required this.htmlData, required this.intentFrom,required this.registrationNumber,required this.dob});
  ...
  class _FullScreenWebViewState extends State<FullScreenWebView> {
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(
          title: Text(
              widget.intentFrom == 'admitCard' ? 'Admit Cards Detail' : 'Marksheet',
